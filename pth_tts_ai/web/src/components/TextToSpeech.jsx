...
export default function TextToSpeech() {
    ...
    return (
        <form onSubmit={handleSubmit} className="flex flex-col gap-2">
            <textarea className="textarea h-24 w-full bg-gray-200" placeholder="Write the text" name="text"></textarea>

            <button className="btn w-full bg-yellow-500 hover:bg-yellow-400 text-lg font-semibold">Read</button>

            <span className="font-semibold text-md border-b-2 border-yellow-400">Volume</span>
            ...
            <span className="font-semibold text-md border-b-2 border-yellow-400">Vibes</span>
